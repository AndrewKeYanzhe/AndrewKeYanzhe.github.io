...
const dariKiriCepatJalan = new malayCommand("Dari kiri, cepat jalan", "Towards the commander's left, quick march", "bleep.mp3");
...
function loadSoundButton(options, chosen, index){
...
function loadSoundMCQ(vocab){
    ...
    soundDiv.getElementsByClassName("sound1")[0].addEventListener("click", function(){
        options[0].sound.play();
        chosen = options[0];
    });
    soundDiv.getElementsByClassName("sound2")[0].addEventListener("click", function(){
        options[1].sound.play();
        chosen = options[1];
    });
    soundDiv.getElementsByClassName("sound3")[0].addEventListener("click", function(){
        options[2].sound.play();
        chosen = options[2];
    });    
...
function unloadSoundMCQ(soundDiv, options){
    ...
    //soundDiv.getElementsByClassName("sound1")[0].removeEventListener("click", listener[]);
    //soundDiv.getElementsByClassName("sound2")[0].removeEventListener("click", listener[]);
    //soundDiv.getElementsByClassName("sound3")[0].removeEventListener("click", listener[]);
}
